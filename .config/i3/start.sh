...
exec xgifwallpaper -s FILL --scale-filter PIXEL -d 16 /home/Akqir/Pictures/Wallpaper/Gif/nautr_girl.gif & 
echo "---" | tee -a /tmp/polybar1.log /tmp/polybar2.log ; polybar bar1 2>&1 | tee -a /tmp/polybar1.log & disown &
picom & autotiling & dunst &
